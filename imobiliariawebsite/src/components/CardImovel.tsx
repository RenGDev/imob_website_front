...
export function CardImovel({data} : {data: ImovelItf}){
    return(
        ...
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <img className="rounded-t-lg object-cover w-full" src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSI7qpM9P3x3tmRUFYJ21fY6mEQ3eb4BdMNlg&s' alt="Foto" />
            <div className="p-5">
